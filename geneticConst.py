...
# FIND OUT CYSTEINE CODON ABRV FOR UGU/UGC
codons = {'UUU':'F','UUC':'F','UUA':'L','UUG':'L','CUU':'L','CUC':'L','CUA':'L','CUG':'L','AUU':'I',
          ...
          'ACG':'T','GCU':'A','GCC':'A','GCA':'A','GCG':'A','UAU':'Y','UAC':'Y','UAA':-1,'UAG':-1,
          'CAU':'H','CAC':'H','CAA':'Q','CAG':'Q','AAU':'N','AAC':'N','AAA':'K','AAG':'K','GAU':'D',
          'GAC':'D','GAA':'E','GAG':'E','UGU':'C','UGC':'C','UGA':-1,'UGG':'W','CGU':'R','CGC':'R',
          'CGA':'R','CGG':'R','AGU':'S','AGC':'S','AGA':'R','AGG':'R','GGU':'G','GGC':'G','GGA':'G','GGG':'G'}

startCodon = {'AUG':'M'}
stopCodons = {'UAA':-1,'UAG':-1,'UGA':-1}
